...
<form action="change_about_me.jsp">
    <h1>Update About You...</h1><br/><br/><br/>
    
    <textarea style="width: 300px; height: 100px;" maxlength="250"  name="about"></textarea>
   <br/><br/>
...
if(request.getParameter("sub")!=null)
{
        ...
        String m=(String)session.getAttribute("em123");
           ...
           PreparedStatement pst=con.prepareStatement("update about_me set about=? where id=?");
    ...
    try{
        ...
        String m=(String)session.getAttribute("em123");
           ...
           Class.forName("com.mysql.jdbc.Driver");
           Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ms","root","");
           PreparedStatement pst=con.prepareStatement("insert into about_me(about,id) values(?,?)");
           pst.setString(1,a);
           pst.setString(2,m);
